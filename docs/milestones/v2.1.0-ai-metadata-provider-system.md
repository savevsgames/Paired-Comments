...
**Status:** 📋 Planning
**Timeline:** 2-3 weeks (November 2025)
...
### Phase 1: Provider Infrastructure (3-4 days)
**Goal:** Build the foundation - provider abstraction, configuration, testing

**Deliverables:**
- `AIMetadataProvider` abstract class
- `OpenAIProvider` implementation
- `ProviderRegistry` for provider selection
- `AIConfig` for loading `.env` and settings
